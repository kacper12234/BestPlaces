...
<table width="1000" border="0" cellpadding="6" cellspacing="2" align="center" >
	<tr bgcolor="#ffddcc">
		...
		<td width="190" align="center"><s:message code="profil.rola"/></td>
		<td width="50"></td>
	</tr>
...
<table width="1000" border="0" cellpadding="6" cellspacing="0" bgcolor="#ffddcc">
	<tr>
		<td align="left">
	<s:message code="info.page"/> <c:out value="${currentPage }"/> <s:message code="info.from"/> <c:out value="${totalPages }"/>
		</td>
