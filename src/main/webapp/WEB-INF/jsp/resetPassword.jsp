...
<sf:form id="usersForm" class="form-container" action="resetpass/sent" modelAttribute="user"
		enctype="multipart/form-data" method="POST">
<h2 align="center"><s:message code="button.resetPass"/></h2>

			<div class="form-group">
			<div><font color="red"><sf:errors path="email"/></font></div>
			<label id="input" for="email"><s:message code="register.email"/></label>
				<sf:input type="text" path="email" id="email"/>
</div>

			<div id="btn">
					<button type="submit" class="btn btn-success btn-lg"><s:message code="button.reset"/></button>
