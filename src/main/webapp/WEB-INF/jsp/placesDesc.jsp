    ...
    <div id="bg">
        ...
        <div id="place" class="container">
                                        ...
                                        <c:when test="${user == p.user.username }">
                                            <div class="content">
                                                <a href="#usure2" data-toggle="modal" data-target="#usure2"
                                                   onclick="takenr(1)"><i class="fas fa-trash-alt fa-2x"></i></a>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
            ...
            <div class="col-lg">
                            ...
                            <c:when test="${user == p.user.email}">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="#addphoto" data-toggle="modal"
                ...
                <p><s:message code="place.author"/><c:out value="${p.user.username}"/></p>
            </div>
        </div>
            ...
            <sec:authorize access="isAuthenticated()">
                <sf:form class="form" action="/places/${p.type}/${p.name}/addcom" modelAttribute="reaction" method="POST">
                    ...
                    <div class="form-group">
                        <label for="mycom">
                            <c:choose>
                                <c:when test="${empty reaction.comment}">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="row">
                                ...
                                <button id="bcom" type="button" class="btn btn-danger btn-lg"
                                        onclick="window.location.href='${pageContext.request.contextPath}/place/${p.type }/${p.name }/delcom'">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${currentPage > 1 }">
                                <li class="page-item"
                                    onclick="window.location.href='${pageContext.request.contextPath}/places/${p.type }/${p.name }/${currentPage - 1}'">
        ...
        <div class="modal" id="usure" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-primary" href="/place/${p.user.email }/${p.name }/delete"><s:message
                                code="word.tak"/></a>
