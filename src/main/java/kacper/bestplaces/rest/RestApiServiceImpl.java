...
public class RestApiServiceImpl implements RestApiService {
    ...
    public void savePlace(Details details, PhotoList<Photo> photoList, String cat) throws IOException {
        if (photoList.size() > 0) {
            Place place = new Place();
            place.setUser(placesService.getUser("kacpermochniej1999@gmail.com"));
